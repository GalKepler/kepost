...
def _build_parser(**kwargs):
    ...
    verstr = f"kepost v{config.environment.version}"
    ...
    parser = ArgumentParser(
        description="kepost: Post-processing of QSIprep workflows v{}".format(
    ...
    parser.add_argument(
        ...
        "kepost (see BIDS-Apps specification).",
    )
